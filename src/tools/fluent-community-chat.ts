...
export const fluentCommunityChatTools: Tool[] = [
  {
...
export const fluentCommunityChatHandlers: Record<string, (args: any) => Promise<any>> = {
  fc_list_chat_threads: async (args: any) => {
    try {
      const params: any = {};
  ...
  fc_list_chat_messages: async (args: any) => {
    try {
      const params: any = {};
      if (args.per_page) params.per_page = args.per_page;
      if (args.page) params.page = args.page;
